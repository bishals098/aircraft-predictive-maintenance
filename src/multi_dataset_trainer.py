...
class MultiDatasetTrainer:
    """Class to handle training across multiple NASA datasets (FD001-FD004)"""
    ...
    def save_dataset_models(self, models, dataset):
        ...
        for model_name, model in models.items():
            if 'lstm' in model_name:
                # PyTorch save - save model state_dict
                torch.save(model.state_dict(), f'{dataset_model_dir}/{model_name}.pth')
            else:
                # Scikit-learn models
